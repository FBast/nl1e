...
export function getConfigAspects() {
    ...
    PL1E.aspects = {
        "modify": {
            "label": "PL1E.Modify",
            "img": "systems/pl1e/assets/icons/svg/modify.svg",
            "dataGroups": {
        ...
        "transfer": {
            "label": "PL1E.Transfer",
            "img": "systems/pl1e/assets/icons/svg/transfer.svg",
            "dataGroups": {
                "aspectsResources": "PL1E.Resources",
                "characteristics": "PL1E.Characteristics",
                "reductions": "PL1E.Reductions"
        ...
        "status": {
            "label": "PL1E.Status",
            "img": "systems/pl1e/assets/icons/svg/status.svg",
            "dataGroups": {
        ...
        "movement": {
            "label": "PL1E.Movement",
            "img": "systems/pl1e/assets/icons/svg/movement.svg",
            "dataGroups": {
        ...
        "invocation": {
            ...
            "img": "systems/pl1e/assets/icons/svg/invocation.svg",
            "dataGroups": {
        ...
        "passiveMacro": {
            "label": "PL1E.Macro",
            "img": "systems/pl1e/assets/icons/svg/dice-target.svg",
            "dataGroups": {
