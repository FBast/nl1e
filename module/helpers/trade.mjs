...
export class Pl1eTrade {
     ...
     */
    static async sellItem(sellerActor, item, buyMultiplier) {
        const price = {
        ...
        await Pl1eChatMessage.tradeMessage(item, sellerActor, null, "sale", priceMoney);
    }
     ...
     * @param {Pl1eItem} item
     */
    static async buyItem(buyerActor, item) {
        ...
        await Pl1eChatMessage.tradeMessage(originalItem, null, buyerActor, "purchase", price);
    }
}